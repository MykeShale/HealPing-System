    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
        <SheetContent side="left" className="w-64 p-0">
          <div className="flex h-full flex-col">
            <div className="flex h-16 items-center gap-2 px-6 border-b bg-gradient-to-r from-green-600 to-green-700">
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      "flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all hover:bg-green-50",
                      isActive ? "bg-green-100 text-green-700 shadow-sm" : "text-gray-600 hover:text-green-700",
                    )}
                  >
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-64 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white shadow-xl">
          <div className="flex h-16 shrink-0 items-center gap-2 px-6 bg-gradient-to-r from-green-600 to-green-700">
            <Heart className="h-8 w-8 text-white" />
            <span className="text-xl font-bold text-white">HealPing</span>
            <Badge variant="secondary" className="ml-auto text-xs">
              Patient
                ...
                return (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className={cn(
                        "group flex gap-x-3 rounded-lg p-3 text-sm font-medium leading-6 transition-all hover:bg-green-50",
                        isActive ? "bg-green-100 text-green-700 shadow-sm" : "text-gray-600 hover:text-green-700",
                      )}
                    >
